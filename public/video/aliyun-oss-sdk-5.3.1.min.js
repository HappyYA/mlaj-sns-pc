...
! function(t) {
	...
	return function() {
		...
		2: [function(t, e, r) {
			(function(r, n) {
				...
				function u(t, e) {
					...
					t && t.inited ? this.options = t : this.options = u.initOptions(t), this.options.cancelFlag = !1, this.options.urllib ? this.urllib = this.options.urllib : (this.urllib = j, this.agent = this.options.agent || I), this.ctx = e, this.userAgent = this._getUserAgent(), this.options.amendTimeSkewed = 0
				}
				...
				e.exports = u, u.initOptions = function(t) {
					...
					if((0, d.default)(t).forEach(function(e) {
							void 0 !== t[e] && (r[e] = t[e])
						}), r.accessKeyId = r.accessKeyId.trim(), r.accessKeySecret = r.accessKeySecret.trim(), r.timeout && (r.timeout = _(r.timeout)), r.endpoint) r.endpoint = a(r.endpoint, r.secure);
					else {
				...
				var L = u.prototype;
				x(L, t("./object")), x(L, t("./managed_upload")), x(L, t("../common/multipart")), x(L, t("../common/thunkpool.js")), u.Wrapper = t("./wrapper"), L.signature = function(t) {
					return h("authorization stringToSign: %s", t), C.computeSignature(this.options.accessKeySecret, t)
					...
					this.options.stsToken && (e["x-oss-security-token"] = this.options.stsToken), b(t.headers).to(e), o(e, "Content-Type") || (t.mime === y.default_type && (t.mime = ""), t.mime && t.mime.indexOf("/") > 0 ? e["Content-Type"] = t.mime : e["Content-Type"] = y.getType(t.mime || v.extname(t.object || "")) || "application/octet-stream"), t.content && (e["Content-Md5"] = m.createHash("md5").update(new n(t.content, "utf8")).digest("base64"), e["Content-Length"] || (e["Content-Length"] = t.content.length));
					...
					return p.default.wrap(function(t) {
						for(;;) switch(t.prev = t.next) {
							case 0:
								return r = this.createRequest(e), n = void 0, i = void 0, t.prev = 3, t.next = 6, this.urllib.request(r.url, r.params);
							case 6:
								n = t.sent, h("response %s %s, got %s, headers: %j", e.method, r.url, n.status, n.headers), t.next = 13;
								break;
							case 10:
					...
					return p.default.wrap(function(t) {
						for(;;) switch(t.prev = t.next) {
							case 0:
								...
								break;
							case 5:
								return n = String(e.data), h("request response error data: %s", n), i = void 0, t.prev = 8, t.next = 11, this.parseXML(n) || {};
							case 11:
								i = t.sent, t.next = 21;
								break;
							case 14:
								return t.prev = 14, t.t0 = t.catch(8), h(n), t.t0.message += "\nraw xml: " + n, t.t0.status = e.status, t.t0.requestId = e.headers["x-oss-request-id"], t.abrupt("return", t.t0);
							case 21:
								o = i.Message || "unknow request error, status: " + e.status, i.Condition && (o += " (condition: " + i.Condition + ")"), r = new Error(o), r.name = i.Code ? i.Code + "Error" : "UnknowError", r.status = e.status, r.code = i.Code, r.requestId = i.RequestId, r.hostId = i.HostId, r.serverTime = i.ServerTime;
							case 30:
		...
		3: [function(t, e, r) {
			(function(e) {
				...
				function i(t, e) {
					...
					v.call(this, e), this.file = t, this.reader = new FileReader, this.start = 0, this.finish = !1, this.fileBuffer = null
				}
				...
				h.multipartUpload = c.default.mark(function t(e, r, n) {
					...
					return c.default.wrap(function(t) {
						for(;;) switch(t.prev = t.next) {
							...
							case 5:
								return t.abrupt("return", t.sent);
							case 6:
								return i = 102400, n.mime || (u.file(r) ? n.mime = f.getType(p.extname(r.name)) : u.blob(r) ? n.mime = r.type : n.mime = f.getType(p.extname(r))), n.headers = n.headers || {}, this._convertMetaToHeaders(n.meta, n.headers), t.next = 12, this._getFileSize(r);
							case 12:
								if(!((o = t.sent) < i)) {
									t.next = 25;
									break
							...
							case 22:
								...
								}, (n.headers && n.headers["x-oss-callback"] || n.callback) && (l.data = s.data), t.abrupt("return", l);
							case 25:
							...
							case 29:
								if(d = t.sent, h = d.uploadId, m = this._getPartSize(o, n.partSize), v = {
										file: r,
										name: e,
										fileSize: o,
										partSize: m,
					...
					return c.default.wrap(function(t) {
						for(;;) switch(t.prev = t.next) {
							...
							case 2:
								if(n = e.file, i = e.fileSize, o = e.partSize, s = e.uploadId, u = e.doneParts, l = e.name, p = [], u.length > 0 && d(u).to(p), f = this._divideParts(i, o), h = f.length, m = !1, v = c.default.mark(function t(i, o) {
										var a, d, v;
										return c.default.wrap(function(t) {
											for(;;) switch(t.prev = t.next) {
												case 0:
									...
									}), _ = 5, w = r.parallel || _, !this.checkBrowserAndVersion("Internet Explorer", "10") && 1 !== w) {
									t.next = 26;
									break
								}
								x = 0;
							...
							case 30:
								...
								throw this.resetCancelFlag(), k = T[0], k.message = "Failed to upload some parts with error: " + k.toString() + " part_num: " + k.partNum, k;
							case 37:
								if(!this.isCancel()) {
									t.next = 40;
									break
				...
				var m = t("stream"),
					v = m.Readable;
				l.inherits(i, v), i.prototype.readFileAndPush = function(t) {
					if(this.fileBuffer)
			...
			y.append = s.default.mark(function t(e, r, n) {
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						...
						case 6:
							return i = t.sent, i.nextAppendPosition = i.res.headers["x-oss-next-append-position"], t.abrupt("return", i);
						case 9:
						case "end":
							return t.stop()
					}
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						...
						case 6:
							...
							return n.mime || (p.file(r) ? n.mime = m.getType(h.extname(r.name)) : n.mime = r.type), o = this._createStream(r, 0, r.size), t.next = 11, this._getFileSize(r);
						case 11:
						...
						case 18:
							return n.headers = n.headers || {}, this._convertMetaToHeaders(n.meta, n.headers), a = n.method || "PUT", c = this._objectRequestParams(a, e, n), v.encodeCallback(c, n), c.mime = n.mime, c.content = i, c.successStatuses = [200], t.next = 28, this.request(c);
						case 28:
							return u = t.sent, l = {
								name: e,
								url: this._objectUrl(e),
								res: u.res
							}, c.headers && c.headers["x-oss-callback"] && (l.data = JSON.parse(u.data.toString())), t.abrupt("return", l);
						case 32:
						case "end":
							return t.stop()
					}
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return n = n || {}, n.headers = n.headers || {}, n.contentLength ? n.headers["Content-Length"] = n.contentLength : n.headers["Transfer-Encoding"] = "chunked", this._convertMetaToHeaders(n.meta, n.headers), i = n.method || "PUT", o = this._objectRequestParams(i, e, n), v.encodeCallback(o, n), o.mime = n.mime, o.stream = r, o.successStatuses = [200], t.next = 12, this.request(o);
						case 12:
							return a = t.sent, c = {
								name: e,
								url: this._objectUrl(e),
								res: a.res
							}, o.headers && o.headers["x-oss-callback"] && (c.data = JSON.parse(a.data.toString())), t.abrupt("return", c);
						case 16:
						case "end":
							return t.stop()
					}
					...
					for(;;) switch(t.prev = t.next) {
						...
						case 4:
							return i = t.sent, a = {
								...
								res: i.res,
								status: i.status
							}, 200 === i.status && (0, o.default)(i.headers).forEach(function(t) {
								0 === t.indexOf("x-oss-meta-") && (a.meta || (a.meta = {}), a.meta[t.substring(11)] = i.headers[t])
							}), t.abrupt("return", a);
						case 8:
						case "end":
							return t.stop()
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return i = null, o = !1, p.writableStream(r) ? i = r : p.string(r) ? (i = l.createWriteStream(r), o = !0) : n = r, n = n || {}, n.process && (n.subres = n.subres || {}, n.subres["x-oss-process"] = n.process), a = void 0, t.prev = 6, u = this._objectRequestParams("GET", e, n), u.writeStream = i, u.successStatuses = [200, 206, 304], t.next = 12, this.request(u);
						case 12:
						...
						case 16:
							...
							return i.destroy(), c("get error: %s, delete the exists file %s", t.t0, r), t.next = 23, this._deleteFileSafe(r);
						case 23:
							throw t.t0;
						case 24:
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							...
							return n += "</Delete>", c("delete multi objects: %s", n), r.subres = "delete", o = this._objectRequestParams("POST", "", r), o.mime = "xml", o.content = n, o.xmlResponse = !0, o.successStatuses = [200], t.next = 14, this.request(o);
						case 14:
							return a = t.sent, l = a.data, p = l && l.Deleted || null, p && (Array.isArray(p) || (p = [p]), p = p.map(function(t) {
								return t.Key
							})), t.abrupt("return", {
								res: a.res,
								deleted: p
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return n = n || {}, n.headers = n.headers || {}, (0, o.default)(n.headers).forEach(function(t) {
								n.headers["x-oss-copy-source-" + t.toLowerCase()] = n.headers[t]
							}), n.meta && (n.headers["x-oss-metadata-directive"] = "REPLACE"), this._convertMetaToHeaders(n.meta, n.headers), r = "/" !== r[0] ? "/" + this.options.bucket + "/" + encodeURIComponent(r) : "/" + encodeURIComponent(r.slice(1)), n.headers["x-oss-copy-source"] = r, i = this._objectRequestParams("PUT", e, n), i.xmlResponse = !0, i.successStatuses = [200, 304], t.next = 12, this.request(i);
						case 12:
							return a = t.sent, c = a.data, c && (c = {
								etag: c.ETag,
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						...
						case 6:
							...
							})), c = i.data.CommonPrefixes || null, c && (Array.isArray(c) || (c = [c]), c = c.map(function(t) {
								return t.Prefix
							})), t.abrupt("return", {
								res: i.res,
								objects: o,
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return n = n || {}, n.subres = "acl", n.headers = n.headers || {}, n.headers["x-oss-object-acl"] = r, e = this._objectName(e), i = this._objectRequestParams("PUT", e, n), i.successStatuses = [200], t.next = 9, this.request(i);
						case 9:
				...
				return s.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return r = r || {}, r.subres = "restore", n = this._objectRequestParams("POST", e, r), n.successStatuses = [202], t.next = 6, this.request(n);
						case 6:
							return i = t.sent, t.abrupt("return", {
								res: i.res
							});
				...
				}, d(o.subResource).to(a.query), a.format()
				...
				t && (0, o.default)(t).forEach(function(r) {
					e["x-oss-meta-" + r] = t[r]
				})
			}, y._deleteFileSafe = function(t) {
				return function(e) {
					l.exists(t, function(r) {
						r ? l.unlink(t, function(r) {
		...
		8: [function(t, e, r) {
			...
			s.listUploads = i.default.mark(function t(e, r) {
				...
				return i.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return r = r || {}, n = {}, o(r).to(n), n.subres = "uploads", a = this._objectRequestParams("GET", "", n), a.query = e, a.xmlResponse = !0, a.successStatuses = [200], t.next = 10, this.request(a);
						case 10:
							return s = t.sent, c = s.data.Upload || [], Array.isArray(c) || (c = [c]), c = c.map(function(t) {
								return {
									name: t.Key,
									uploadId: t.UploadId,
				...
				return i.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return a = a || {}, s = {}, o(a).to(s), s.subres = {
								uploadId: r
							}, c = this._objectRequestParams("GET", e, s), c.query = n, c.xmlResponse = !0, c.successStatuses = [200], t.next = 10, this.request(c);
						case 10:
				...
				return i.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return this.cancel(), n = n || {}, a = {}, o(n).to(a), a.subres = {
								uploadId: r
							}, s = this._objectRequestParams("DELETE", e, a), s.successStatuses = [204], t.next = 9, this.request(s);
						case 9:
				...
				return i.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return r = r || {}, n = {}, o(r).to(n), n.headers = n.headers || {}, this._convertMetaToHeaders(r.meta, n.headers), n.subres = "uploads", a = this._objectRequestParams("POST", e, n), a.mime = r.mime, a.xmlResponse = !0, a.successStatuses = [200], t.next = 12, this.request(a);
						case 12:
				...
				return i.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							for(c = n.concat().sort(function(t, e) {
							...
							return u += "</CompleteMultipartUpload>", s = s || {}, f = {}, o(s).to(f), f.subres = {
								uploadId: r
							}, d = this._objectRequestParams("POST", e, f), a.encodeCallback(d, f), d.mime = "xml", d.content = u, d.headers && d.headers["x-oss-callback"] || (d.xmlResponse = !0), d.successStatuses = [200], t.next = 16, this.request(d);
						case 16:
							return h = t.sent, m = {
								res: h.res,
								bucket: d.bucket,
							...
							}, d.headers && d.headers["x-oss-callback"] && (m.data = JSON.parse(h.data.toString())), t.abrupt("return", m);
						case 20:
						case "end":
							return t.stop()
					}
				...
				return i.default.wrap(function(t) {
					for(;;) switch(t.prev = t.next) {
						case 0:
							return s = s || {}, c = {}, o(s).to(c), c.headers = {
								"Content-Length": a.size
							}, c.subres = {
								partNumber: n,
								uploadId: r
							}, u = this._objectRequestParams("PUT", e, c), u.mime = c.mime, u.stream = a.stream, u.successStatuses = [200], t.next = 11, this.request(u);
						case 11:
							return l = t.sent, a.stream = null, u.stream = null, t.abrupt("return", {
								name: e,
		...
		10: [function(t, e, r) {
			...
			c._thunkPool = function(t, e) {
				...
				return new s(function(a) {
					...
					for(var u = i.default.mark(s), p = new n(e, a), f = 0; f < t.length; f++) o(s(f)).catch(c)
				})
			}, c.cancel = function() {
		...
		38: [function(t, e, r) {
			(function(e) {
				...
				o.prototype.slice = function(t, e) {
					...
					return t = +t, e |= 0, r || M(this, t, e, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : D(this, t, e, !0), e + 2
				}, o.prototype.writeUInt16BE = function(t, e, r) {
					return t = +t, e |= 0, r || M(this, t, e, 2, 65535, 0), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : D(this, t, e, !1), e + 2
				}, o.prototype.writeUInt32LE = function(t, e, r) {
					return t = +t, e |= 0, r || M(this, t, e, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : R(this, t, e, !0), e + 4
				}, o.prototype.writeUInt32BE = function(t, e, r) {
					return t = +t, e |= 0, r || M(this, t, e, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : R(this, t, e, !1), e + 4
					...
					return t = +t, e |= 0, r || M(this, t, e, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : D(this, t, e, !0), e + 2
				}, o.prototype.writeInt16BE = function(t, e, r) {
					return t = +t, e |= 0, r || M(this, t, e, 2, 32767, -32768), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : D(this, t, e, !1), e + 2
				}, o.prototype.writeInt32LE = function(t, e, r) {
					return t = +t, e |= 0, r || M(this, t, e, 4, 2147483647, -2147483648), o.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : R(this, t, e, !0), e + 4
				}, o.prototype.writeInt32BE = function(t, e, r) {
					return t = +t, e |= 0, r || M(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : R(this, t, e, !1), e + 4
						...
						y(function() {
							for(var n = t._v, i = 1 == t._s, o = 0; r.length > o;) ! function(e) {
								var r, o, a, s = i ? e.ok : e.fail,
									...
									l = e.domain;
								try {
									s ? (i || (2 == t._h && D(t), t._h = 1), !0 === s ? r = n : (l && l.enter(), r = s(n), l && (l.exit(), a = !0)), r === e.promise ? u(E("Promise-chain cycle")) : (o = P(r)) ? o.call(r, c, u) : c(r)) : u(n)
								} catch(t) {
									l && !a && l.exit(), u(t)
								}
							}(r[o++]);
		...
		146: [function(t, e, r) {
			...
			}), C.prototype[M] || t("./_hide")(C.prototype, M, C.prototype.valueOf), p(C, "Symbol"), p(Math, "Math", !0), p(n.JSON, "JSON", !0)
		}, {
			"./_an-object": 61,
			"./_descriptors": 69,
			"./_enum-keys": 72,
			...
			(function(e) {
				(function() {
					...
					function h(t) {
						...
						if(R && (b = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(R) || /(?:alpha|beta)(?: ?\d)?/i.exec(t + ";" + (D && a.appMinorVersion)) || /\bMinefield\b/i.test(t) && "a") && (M = /b/i.test(b) ? "beta" : "alpha", R = R.replace(RegExp(b + "\\+?$"), "") + ("beta" == M ? A : O) + (/\d+\+?/.exec(b) || "")), "Fennec" == B || "Firefox" == B && /\b(?:Android|Firefox OS)\b/.test(X)) B = "Firefox Mobile";
						...
						var G = {};
						return G.description = t, G.layout = U && U[0], G.manufacturer = q, G.name = B, G.prerelease = M, G.product = F, G.ua = t, G.version = B && R, G.os = X || {
							architecture: null,
							family: null,
							version: null,
							toString: function() {
		...
		174: [function(e, r, n) {
			(function(e) {
				! function(i) {
					...
					function f(t, e, r) {
						var n = 0;
						for(t = r ? D(t / j) : t >> 1, t += D(t / e); t > M * T >> 1; n += E) t = D(t / M);
		...
		183: [function(t, e, r) {
			(function(r, n) {
				...
				e.exports = l;
				var R, U = !r.browser && ["v0.10", "v0.9."].indexOf(r.version.slice(0, 5)) > -1 ? M.default : D.nextTick;
				l.WritableState = u;
			...
			(function(e) {
				...
				! function(r) {
					function n(t, e) {
						if(!(this instanceof n)) return new n(t, e);
						var i = this;
						a(i), i.q = i.c = "", i.bufferCheckPosition = r.MAX_BUFFER_LENGTH, i.opt = e || {}, i.opt.lowercase = i.opt.lowercase || i.opt.lowercasetags, i.looseCase = i.opt.lowercase ? "toLowerCase" : "toUpperCase", i.tags = [], i.closed = i.closedRoot = i.sawRoot = !1, i.tag = i.error = null, i.strict = !!t, i.noscript = !(!t && !i.opt.noscript), i.state = V.BEGIN, i.strictEntities = i.opt.strictEntities, i.ENTITIES = i.strictEntities ? (0,
						...
						for(var r = 0, n = "";;) {
							...
							switch(e.trackPosition && (e.position++, "\n" === n ? (e.line++, e.column = 0) : e.column++), e.state) {
								...
								case V.ATTRIB_VALUE_ENTITY_U:
									...
									";" === n ? (e[c] += P(e), e.entity = "", e.state = s) : y(e.entity.length ? Y : W, n) ? e.entity += n : (k(e, "Invalid character in entity name"), e[c] += "&" + e.entity + n, e.entity = "", e.state = s);
									continue;
								default:
				...
				if(!w[d] && (S || d && !x[d])) {
					...
					if(!N)
						for(var C = this.hostname.split(/\./), k = 0, P = C.length; k < P; k++) {
							var I = C[k];
							if(I && !I.match(y)) {
								for(var L = "", M = 0, D = I.length; M < D; M++) I.charCodeAt(M) > 127 ? L += "x" : L += I[M];
								if(!L.match(y)) {
									var R = C.slice(0, k),
										U = C.slice(k + 1),
										B = I.match(g);
		...
		207: [function(t, e, r) {
			(function(e, n) {
				...
				r.format = function(t) {
					...
					for(var r = 1, n = arguments, o = n.length, a = String(t).replace(P, function(t) {
							if("%%" === t) return "%";
							if(r >= o) return t;
							switch(t) {
								case "%s":
		...
		231: [function(t, e, r) {
			...
			(function() {
				...
				c = t("./XMLDeclaration"), u = t("./XMLDocType"), r = t("./XMLCData"), n = t("./XMLComment"), l = t("./XMLElement"), f = t("./XMLRaw"), d = t("./XMLText"), p = t("./XMLProcessingInstruction"), i = t("./XMLDTDAttList"), o = t("./XMLDTDElement"), a = t("./XMLDTDEntity"), s = t("./XMLDTDNotation"), h = t("./XMLWriterBase"), e.exports = function(t) {
					...
					return m(e, t), e.prototype.document = function(t) {
						var e, r, i, o, a;
						for(this.textispresent = !1, o = "",
							a = t.children, r = 0, i = a.length; r < i; r++) e = a[r], o += function() {
							switch(!1) {
								case !(e instanceof c):
		...
		244: [function(t, e, r) {
			(function(e, n) {
				...
				r.request = function(e, n, i) {
					...
					function T(t) {
						if(it && (it.waiting = Date.now() - P), v("Request#%d %s `req response` event emit: status %d, headers: %j", A, i, t.statusCode, t.headers), a.streaming) {
							var e = E(t);
					...
					var I = (a.type || a.method || C.method || "GET").toUpperCase(),
						...
						D = o(a.agent, r.agent),
						R = a.fixJSONCtlChars;
					"https:" === C.protocol && (M = m, D = o(a.httpsAgent, r.httpsAgent), C.port || (L = 443));
					var U = {
					...
					return "undefined" == typeof window ? function() {
						...
						if("opening" === e) return t.once("lookup", function(t, e, r) {
							v("Request#%d %s lookup: %s, %s, %s", A, i, t, e, r), it && (it.dnslookup = Date.now() - P), e && (rt = e)
						}), void t.once("connect", function() {
							it && (it.connected = Date.now() - P), c(), k(), v("Request#%d %s new socket connected", A, i), Q = !0, rt || (rt = t.remoteAddress), nt = t.remotePort
						});
